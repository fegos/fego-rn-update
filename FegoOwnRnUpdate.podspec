#
#  Be sure to run `pod spec lint NIPHotReload.podspec' to ensure this is a
...
version = package['version']
  ...
  s.description  = <<-DESC
  private react-native hotreload comonpent 
                   DESC
